...
//    imgUrl_alt:"static/assets/bg_1.jpg"
  ...
  methods: {
    ...
    next() {
      this.$ajax({
        method: "get",
//      url: "http://202.206.249.16:8080/dxpj/zp/judge_IsActivity"
...
//  console.log('url:'+this.GLOBAL.serverSrc+"get_backBround?PictureTypeID=01&AssessTypeID=01");
    this.$ajax({
      method: "get",
//    url:this.GLOBAL.serverSrc+'get_backBround?PictureTypeID=01&AssessTypeID=01'
      url:'get_backBround?PictureTypeID=01&AssessTypeID=01'
    })
      .then(res => {
        //info
        res = res.data;
...
//      this.imgUrl_alt = res.PictureTypeName.substring(6);
//      console.log('-------imgUrl_alt:--------'+imgUrl_alt);
    ...
    this.$ajax({
      method: "get",
//    url: this.GLOBAL.serverSrc+"get_A_Description"
