...
export default {
  ...
  created: function() {
    ...
    ///dxpj/zzp/get_backBround?PictureTypeID=01&AssessTypeID=02
    this.$ajax({
      method: "get",
      url:
        "get_backBround?PictureTypeID=01&AssessTypeID=04"
    })
      .then(res => {
        //info
